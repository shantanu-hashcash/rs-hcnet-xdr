...
impl From<hcnet_strkey::DecodeError> for Error {
    fn from(_: hcnet_strkey::DecodeError) -> Self {
        Error::Invalid
    }
}
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            PublicKey::PublicKeyTypeEd25519(Uint256(k)) => {
                let k = hcnet_strkey::ed25519::PublicKey::from_payload(k)
...
impl core::str::FromStr for PublicKey {
    ...
    fn from_str(s: &str) -> core::result::Result<Self, Self::Err> {
        let hcnet_strkey::ed25519::PublicKey(k) =
            hcnet_strkey::ed25519::PublicKey::from_str(s)?;
...
impl core::fmt::Display for MuxedAccountMed25519 {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        ...
        let k = hcnet_strkey::ed25519::MuxedAccount {
            ed25519: *ed25519,
            id: *id,
        };
        let s = k.to_string();
...
impl core::str::FromStr for MuxedAccountMed25519 {
    type Err = Error;
    fn from_str(s: &str) -> core::result::Result<Self, Self::Err> {
        let hcnet_strkey::ed25519::MuxedAccount { ed25519, id } =
            hcnet_strkey::ed25519::MuxedAccount::from_str(s)?;
...
impl core::str::FromStr for MuxedAccount {
    type Err = Error;
    fn from_str(s: &str) -> core::result::Result<Self, Self::Err> {
        let strkey = hcnet_strkey::Strkey::from_str(s)?;
        match strkey {
            hcnet_strkey::Strkey::PublicKeyEd25519(hcnet_strkey::ed25519::PublicKey(k)) => {
                Ok(MuxedAccount::Ed25519(Uint256(k)))
            }
            hcnet_strkey::Strkey::MuxedAccountEd25519(
                hcnet_strkey::ed25519::MuxedAccount { ed25519, id },
            ) => Ok(MuxedAccount::MuxedEd25519(MuxedAccountMed25519 {
                ed25519: Uint256(ed25519),
                id,
            })),
            hcnet_strkey::Strkey::PrivateKeyEd25519(_)
            | hcnet_strkey::Strkey::PreAuthTx(_)
            | hcnet_strkey::Strkey::HashX(_)
            | hcnet_strkey::Strkey::SignedPayloadEd25519(_)
            | hcnet_strkey::Strkey::Contract(_) => Err(Error::Invalid),
        }
    }
}
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            MuxedAccount::Ed25519(Uint256(k)) => {
                let k = hcnet_strkey::ed25519::PublicKey(*k);
                let s = k.to_string();
                f.write_str(&s)?;
            }
...
impl core::fmt::Display for SignerKeyEd25519SignedPayload {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        ...
        let k = hcnet_strkey::ed25519::SignedPayload {
            ed25519: *ed25519,
...
impl core::str::FromStr for SignerKeyEd25519SignedPayload {
    type Err = Error;
    fn from_str(s: &str) -> core::result::Result<Self, Self::Err> {
        let hcnet_strkey::ed25519::SignedPayload { ed25519, payload } =
            hcnet_strkey::ed25519::SignedPayload::from_str(s)?;
...
impl core::str::FromStr for SignerKey {
    ...
    fn from_str(s: &str) -> core::result::Result<Self, Self::Err> {
        ...
        match strkey {
            ...
            hcnet_strkey::Strkey::PreAuthTx(hcnet_strkey::PreAuthTx(h)) => {
                Ok(SignerKey::PreAuthTx(Uint256(h)))
            }
            hcnet_strkey::Strkey::HashX(hcnet_strkey::HashX(h)) => {
                Ok(SignerKey::HashX(Uint256(h)))
            }
            hcnet_strkey::Strkey::SignedPayloadEd25519(
                hcnet_strkey::ed25519::SignedPayload { ed25519, payload },
            ...
            hcnet_strkey::Strkey::PrivateKeyEd25519(_)
            | hcnet_strkey::Strkey::Contract(_)
            | hcnet_strkey::Strkey::MuxedAccountEd25519(_) => Err(Error::Invalid),
        }
    }
}
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            ...
            SignerKey::PreAuthTx(Uint256(h)) => {
                let k = hcnet_strkey::PreAuthTx(*h);
                let s = k.to_string();
                f.write_str(&s)?;
            }
            SignerKey::HashX(Uint256(h)) => {
                let k = hcnet_strkey::HashX(*h);
                let s = k.to_string();
                f.write_str(&s)?;
            }
...
impl core::str::FromStr for ScAddress {
    ...
    fn from_str(s: &str) -> core::result::Result<Self, Self::Err> {
        let strkey = hcnet_strkey::Strkey::from_str(s)?;
        match strkey {
            hcnet_strkey::Strkey::PublicKeyEd25519(hcnet_strkey::ed25519::PublicKey(k)) => Ok(
                ScAddress::Account(AccountId(PublicKey::PublicKeyTypeEd25519(Uint256(k)))),
            ),
            hcnet_strkey::Strkey::Contract(hcnet_strkey::Contract(h)) => {
                Ok(ScAddress::Contract(Hash(h)))
            }
            hcnet_strkey::Strkey::MuxedAccountEd25519(_)
            | hcnet_strkey::Strkey::PrivateKeyEd25519(_)
            | hcnet_strkey::Strkey::PreAuthTx(_)
            | hcnet_strkey::Strkey::HashX(_)
            | hcnet_strkey::Strkey::SignedPayloadEd25519(_) => Err(Error::Invalid),
        }
    }
}
